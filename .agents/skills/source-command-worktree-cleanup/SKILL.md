---
name: "source-command-worktree-cleanup"
description: "Optional flags like --all, --stale 30, --dry-run, --force"
---

# source-command-worktree-cleanup

Use this skill when the user asks to run the migrated source command `worktree-cleanup`.
...
Use this skill when the user asks to clean up worktrees. Treat any text after the command name as the cleanup target or flags. If the target is unclear, inspect active worktrees first and ask only when the cleanup choice would be destructive or ambiguous.
