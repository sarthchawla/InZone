---
name: "source-command-update-mr"
description: "Run the migrated source command `update-mr`."
---

# source-command-update-mr

Use this skill when the user asks to run the migrated source command `update-mr`.
...
Use this skill when the user asks to update an MR/PR. Treat any text after the command name as the target MR/PR identifier or update request. Resolve placeholders from the user's request and repository context before running commands; do not depend on slash-command template expansion.
