---
name: "source-command-fix-vercel-deployment"
description: "Run the migrated source command `fix-vercel-deployment`."
---

# source-command-fix-vercel-deployment

Use this skill when the user asks to run the migrated source command `fix-vercel-deployment`.
...
Use this skill when the user asks to fix a Vercel deployment. Treat any text after the command name as the deployment URL, project, branch, file, or error context. Read referenced files explicitly and resolve deployment details from the user's request plus available repo/config context before running commands.
