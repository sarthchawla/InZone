---
name: "source-command-worktree-list"
description: "List all active git worktrees with their port configurations"
---

# source-command-worktree-list

Use this skill when the user asks to run the migrated source command `worktree-list`.
...
Use this skill when the user asks to list worktrees. Treat any text after the command name as filtering or formatting guidance. Prefer read-only inspection commands and summarize active worktrees clearly.
