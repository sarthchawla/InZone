---
name: "source-command-create-mr"
description: "Run the migrated source command `create-mr`."
---

# source-command-create-mr

Use this skill when the user asks to run the migrated source command `create-mr`.
...
Use this skill when the user asks to create an MR/PR. Treat any text after the command name as the title, target branch, draft/readiness preference, or extra PR instructions. Resolve placeholders from the user's request and repository context before running commands; do not depend on slash-command template expansion.
