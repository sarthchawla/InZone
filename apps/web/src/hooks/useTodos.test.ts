...
import { createMockTodo, API_BASE } from "../test/mocks/handlers";
...
describe("useUpdateTodo hook", () => {
  ...
  describe("error handling", () => {
    it("handles 404 for non-existent todo", async () => {
      server.use(
        http.put(`${API_BASE}/api/todos/:id`, () => {
...
describe("useMoveTodo hook", () => {
  ...
  describe("error handling", () => {
    it("handles 404 for non-existent todo", async () => {
      server.use(
        http.patch(`${API_BASE}/api/todos/:id/move`, () => {
          return HttpResponse.json({ error: "Todo not found" }, { status: 404 });
        })
      );
...
describe("useArchiveTodo hook", () => {
  ...
  describe("error handling", () => {
    it("handles 404 for non-existent todo", async () => {
      server.use(
        http.patch(`${API_BASE}/api/todos/:id/archive`, () => {
          return HttpResponse.json({ error: "Todo not found" }, { status: 404 });
        })
      );
