  ...
  return (
    ...
    >
      <div className="space-y-4" onKeyDown={handleKeyDown}>
        {/* Title */}
        <div>
          <label htmlFor="todoTitle" className="block text-sm font-medium text-muted-foreground mb-1">
            Title
          </label>
          <Input
            id="todoTitle"
        ...
        {/* Due Date */}
        <div>
          <label htmlFor="todoDueDate" className="block text-sm font-medium text-muted-foreground mb-1">
            Due Date
          </label>
          <input
            type="date"
            ...
            className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent text-sm"
          />
        </div>
