      ...
      <div className="space-y-1">
        {shortcuts.map((shortcut) => (
          <div key={shortcut.key} className="flex items-center justify-between py-2">
            ...
            <kbd className="inline-flex items-center justify-center min-w-[28px] h-7 px-2 bg-stone-100 border border-stone-300 rounded-lg text-xs font-mono font-medium text-stone-700 shadow-sm">
