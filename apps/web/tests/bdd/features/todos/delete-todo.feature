Feature: Delete Todo
  ...
  @skip
  # SKIP: Delete button on TodoCard not implemented - delete is only via edit modal
  ...
  @skip
  # SKIP: Delete from edit modal doesn't show confirmation dialog - deletes immediately
  ...
  @skip
  # SKIP: Delete button on TodoCard not implemented
  ...
  @skip
  # SKIP: Todo selection and keyboard shortcuts not implemented
  ...
  @skip
  # SKIP: Confirmation dialog not implemented for modal delete (direct delete)
